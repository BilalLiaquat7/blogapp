...
RSpec.describe 'users#show', type: :feature do
  before do
    ...
    @post2 = Post.create(author: @user1, title: 'Hi Hello', text: 'Great', commentssCounter: 2, likesCounter: 3)
    @post3 = Post.create(author: @user1, title: 'Hello Hi', text: 'Awesome.', commentssCounter: 1, likesCounter: 2)
  end
